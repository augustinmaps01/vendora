...
// ---------------------------------------------------------------------------
// Grocery & food product data
// ---------------------------------------------------------------------------
const ALL_PRODUCTS = [
    // Rice & Grains
    {
        id: "1",
        name: "Premium Sinandomeng Rice (5kg)",
        price: 320.00,
    ...
    },
    {
        ...
        category: "Rice & Grains",
        image: "https://images.unsplash.com/photo-1517673132405-a56a62b18caf?q=80&w=1200&auto=format&fit=crop",
        badge: "20% OFF",
    ...
    {
        id: "9",
        name: "Canned Sardines Variety Pack (6 cans)",
        price: 145.00,
    ...
    {
        id: "12",
        name: "3-in-1 Coffee Sachets (30 pcs)",
        price: 175.00,
    ...
    {
        id: "13",
        name: "Fresh Buko Juice (6 bottles)",
        price: 150.00,
        category: "Beverages",
    ...
    {
        id: "17",
        name: "Fresh Pasteurized Milk (1 Liter)",
        price: 95.00,
    ...
    {
        id: "18",
        name: "Kesong Puti (Local White Cheese)",
        price: 85.00,
        category: "Dairy & Chilled",
...
const CATEGORY_DATA = [
    ...
    { name: "Rice & Grains", icon: UtensilsCrossed },
    { name: "Fresh Produce", icon: Sparkles },
    { name: "Pantry Staples", icon: Home },
    { name: "Beverages", icon: Dumbbell },
    { name: "Snacks", icon: Shirt },
    { name: "Dairy & Chilled", icon: Laptop },
]

  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Help and Support</h1>
        <p className="text-gray-600 dark:text-[#b4b4d0] mt-2">Get assistance and find answers to your questions</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-[#13132a] p-6 rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm hover:shadow-md transition-shadow cursor-pointer">
          ...
          <p className="text-sm text-gray-600 dark:text-[#b4b4d0]">Browse comprehensive guides and tutorials</p>
        </div>
        ...
        <div className="bg-white dark:bg-[#13132a] p-6 rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm hover:shadow-md transition-shadow cursor-pointer">
          ...
          <p className="text-sm text-gray-600 dark:text-[#b4b4d0]">Watch step-by-step video guides</p>
        </div>
        ...
        <div className="bg-white dark:bg-[#13132a] p-6 rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm hover:shadow-md transition-shadow cursor-pointer">
          ...
          <p className="text-sm text-gray-600 dark:text-[#b4b4d0]">Chat with our support team</p>
        </div>
        ...
        <div className="bg-white dark:bg-[#13132a] p-6 rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm hover:shadow-md transition-shadow cursor-pointer">
          ...
          <p className="text-sm text-gray-600 dark:text-[#b4b4d0]">Find answers to common questions</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-[#13132a] p-6 rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm">
          ...
          <p className="text-sm text-gray-600 dark:text-[#b4b4d0] mb-4">Get help via email within 24 hours</p>
          <p className="text-sm font-medium text-gray-900 dark:text-white mb-4">support@vendora.com</p>
        ...
        <div className="bg-white dark:bg-[#13132a] p-6 rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm">
          ...
          <p className="text-sm text-gray-600 dark:text-[#b4b4d0] mb-4">Talk to our support team</p>
          <p className="text-sm font-medium text-gray-900 dark:text-white mb-4">+63 2 8123 4567</p>
        ...
        <div className="bg-white dark:bg-[#13132a] p-6 rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm">
          ...
          <p className="text-sm text-gray-600 dark:text-[#b4b4d0] mb-4">Chat with an agent now</p>
      ...
      <div className="bg-white dark:bg-[#13132a] rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Popular Help Articles</h2>
        <div className="space-y-4">
          {[
            ...
            <div key={idx} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-[#1a1a35] rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
              <div className="flex items-center gap-4">
                <div className="flex-shrink-0 bg-white dark:bg-[#13132a] p-2 rounded">
                  <FileText className="h-5 w-5 text-gray-600 dark:text-[#b4b4d0]" />
                </div>
                <div>
              ...
              <ExternalLink className="h-4 w-4 text-gray-400 dark:text-[#9898b8]" />
            </div>
          ))}
        </div>
      </div>

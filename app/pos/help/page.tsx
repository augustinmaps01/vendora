  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900">Help and Support</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
          ...
          <p className="text-sm font-medium text-gray-900 mb-4">support@vendora.com</p>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
          ...
          <p className="text-sm font-medium text-gray-900 mb-4">+63 2 8123 4567</p>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
          ...
          <p className="text-sm text-gray-600 mb-4">Chat with an agent now</p>
          <div className="flex items-center gap-2 mb-4">
            <Badge className="bg-green-100 text-green-800 hover:bg-green-100">Online</Badge>
            <span className="text-xs text-gray-600">Usually responds in minutes</span>
          </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-6">Popular Help Articles</h2>

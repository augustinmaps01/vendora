  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Marketing and Ads</h1>
          <p className="text-gray-600 mt-1">Promote your business and engage customers</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-sm text-gray-600 mb-4">Send newsletters and promotional emails to customers</p>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">SMS Marketing</h3>
            <MessageSquare className="h-5 w-5 text-blue-600" />
          </div>
          <p className="text-sm text-gray-600 mb-4">Send text messages and promotions to customers</p>
          <div className="space-y-2 mb-4">
            <div className="flex justify-between text-sm">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-sm text-gray-600 mb-4">Create discount codes and special offers</p>
          <div className="space-y-2 mb-4">
            <div className="flex justify-between text-sm">

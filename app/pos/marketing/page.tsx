  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Marketing and Ads</h1>
          <p className="text-gray-600 dark:text-[#b4b4d0] mt-1">Promote your business and engage customers</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-[#13132a] p-6 rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 dark:text-[#b4b4d0]">Active Campaigns</p>
        ...
        <div className="bg-white dark:bg-[#13132a] p-6 rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 dark:text-[#b4b4d0]">Total Reach</p>
        ...
        <div className="bg-white dark:bg-[#13132a] p-6 rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 dark:text-[#b4b4d0]">Click Rate</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">3.8%</p>
            </div>
        ...
        <div className="bg-white dark:bg-[#13132a] p-6 rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 dark:text-[#b4b4d0]">Conversions</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-[#13132a] p-6 rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-sm text-gray-600 dark:text-[#b4b4d0] mb-4">Send newsletters and promotional emails to customers</p>
        ...
        <div className="bg-white dark:bg-[#13132a] p-6 rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">SMS Marketing</h3>
            <MessageSquare className="h-5 w-5 text-blue-600" />
          </div>
          <p className="text-sm text-gray-600 dark:text-[#b4b4d0] mb-4">Send text messages and promotions to customers</p>
          <div className="space-y-2 mb-4">
            <div className="flex justify-between text-sm">
        ...
        <div className="bg-white dark:bg-[#13132a] p-6 rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-sm text-gray-600 dark:text-[#b4b4d0] mb-4">Create discount codes and special offers</p>
          <div className="space-y-2 mb-4">
            <div className="flex justify-between text-sm">
      ...
      <div className="bg-white dark:bg-[#13132a] rounded-lg border border-gray-200 dark:border-[#2d1b69] shadow-sm p-6">
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={idx} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-[#1a1a35] rounded-lg">

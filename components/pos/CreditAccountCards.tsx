        ...
        <div className={`relative h-3 bg-gray-100 rounded-full overflow-hidden ${className}`}>
            ...
            {showPercent && (
                <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-[10px] font-semibold text-gray-600 mix-blend-multiply">
    ...
    if (accounts.length === 0) {
        return (
            <div className="bg-white p-12 text-center rounded-xl border border-gray-100 shadow-sm">
                ...
                <p className="text-gray-500 font-medium">No credit accounts found</p>
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                                ...
                                <div className="flex items-center gap-3 flex-1">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2 flex-wrap">
                                            <h3 className="text-base font-semibold text-gray-900">{account.customer.name}</h3>
                                ...
                                <div className="flex items-center gap-4 sm:gap-6">
                                    <div className="text-center">
                                        ...
                                        <div className="text-sm font-bold text-gray-900">₱{account.totalAmount.toLocaleString()}</div>
                                    </div>
                                    <div className="text-center">
                            ...
                            <div className="border-t border-gray-100 bg-gray-50/50">
                                <div className="p-4 sm:p-5">
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-3 flex-shrink-0 ml-2">
                                                    <div className="text-right">
                                                        <div className="text-sm font-semibold text-gray-900">₱{item.total.toLocaleString()}</div>
                                    ...
                                    <div className="mt-4 pt-3 border-t border-gray-200 flex items-center justify-between">
                                        <span className="text-sm text-gray-600">Total ({account.items.length} items)</span>
                                        <div className="text-right">
                                            <span className="text-sm font-bold text-gray-900">₱{account.totalAmount.toLocaleString()}</span>
                                            {account.remainingBalance > 0 && (
